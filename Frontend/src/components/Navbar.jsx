...
function Navbar() {
	...
	const navItem = (
		<>
		<li className='text-xl text-red-800 '>
		<a href='/'>Home</a>
		</li> 
		<li className='text-xl text-red-800 '>
  ...
  <div className="navbar-start">
    ...
    <a className="text-red-600 text-2xl font-bold cursor-pointer">BOOKSTORE</a>
  </div>
  ...
  {/* sun icon */}
  <svg className="swap-off fill-current w-8 h-8 dark:bg-slate-900 rounded" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" 
  ...
  {/* moon icon */}
  <svg className="swap-on fill-current w-8 h-8 dark:bg-slate-900  rounded" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
